...
import cn.ganin.services.AbotEnterprise;
...
public class IndexController {
    ...
    @Autowired
    private AbotEnterprise abotEnterprise;
    ...
    public ServiceResponses<enterprise> enterprise(int id){
        return abotEnterprise.enterpriseMsg(id);
    }
    ...
    @ResponseBody
    public ServiceResponses apply(Integer stuid,Integer posiId,Integer enId,HttpServletResponse response){
        response.setHeader("Access-Control-Allow-Origin", "*");
        System.out.println(stuid+":::::"+posiId+":::::"+enId);
        return serarchPosition.apply(stuid,posiId,enId);
    }
