    ...
    <script>
        ...
        function publish(positionId) {
            if("${EnterpriseData.enterprise.enterprise_state}"=="待审核"){
                ...
                if (confirm("您确定要发布吗？")){
                    location.href="${pageContext.request.contextPath}/UpdatePositionPublish?position_id="+positionId+"&enterprise_id=${EnterpriseData.enterprise.enterprise_id}";
                }
            }else {
                alert("您还未认证，请认证后才能发布职位！")
            }
    ...
    <nav class="navbar navbar-default navbar-fixed-top row" style="background-color: white">
        ...
        <div class="col-md-4 col-xs-4">
            <ul class="nav nav-pills ban ul2">
                ...
                <li role="presentation"><a href="http://localhost:8081/index/home.html">主页</a> </li>
        ...
        <div class="search">
            <form method="get" action="http://127.0.0.1:8081/index/search?find=">
            ...
            <table  class="table table-striped">
                ...
                <c:forEach items="${EnterpriseData.enterpriseResumeList}" var="resume" varStatus="vs">
                    <tr>
                        ...
                        <td><a href="/resume.jsp">查看简历</a></td>
                        <td><a href="${pageContext.request.contextPath}/UpdateRecruitState?recruit_id=${resume.recruit_id}&id=${EnterpriseData.enterprise.enterprise_id}">已阅</a></td>
                    </tr>
                </c:forEach>
