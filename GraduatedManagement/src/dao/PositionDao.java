...
public class PositionDao {
    ...
    public List<Position> findPublishedPosition() {
        String sql = "select * from position where position_publish_state = ?";
        List<Position> publishedPosition = template.query(sql, new BeanPropertyRowMapper<Position>(Position.class), "已发布");
        return publishedPosition;
    }

    public List<Position> findPublishingPosition() {
        String sql = "select * from position where position_publish_state = ?";
        List<Position> publishedPosition = template.query(sql, new BeanPropertyRowMapper<Position>(Position.class), "未发布");
        return publishedPosition;
    }
